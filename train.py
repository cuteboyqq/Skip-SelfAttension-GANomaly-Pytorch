...
def get_args():
    ...
    parser.add_argument('-batchsize','--batch-size',type=int,help='train batch size',default=32)
    parser.add_argument('-savedir','--save-dir',help='save model dir',default=r"/home/ali/GitHub_Code/cuteboyqq/GANomaly/Skip-SelfAttension-GANOMALY-Pytorch/runs/train/128-200")
